...
def train(batch_size, epochs, learning_rate, num_factors, deep_layers, model_type):
...
if __name__ == "__main__":
    train(batch_size=1, epochs=100, learning_rate=0.001, num_factors=16, deep_layers=[100, 100], model_type='PNN')
